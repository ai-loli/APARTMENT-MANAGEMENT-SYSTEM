...
getBookingStatus($dbc,$booking_status_code);
 echo '</p>
 <p> Booking Id: <input type="text" name="apt_booking_id" size="10" maxlength="10" value="'.$apt_booking_id.'" /><label></label></p>
...
if (isset($_POST['submitted'])) {
    ...
    $errors = array();
     checkIfEmpty($_POST['apt_booking_id'],"Please enter booking start date.",$errors); 
    ...
    if (empty($errors)) { 
        $query = "INSERT INTO apartment_bookings(apt_booking_id,apt_id,guest_id,booking_status_code,booking_start_date,booking_end_date)
        VALUES ($apt_booking_id,$apt_id,$guest_id,$booking_status_code,'$start_date 00:00:00','$end_date 00:00:00')";
