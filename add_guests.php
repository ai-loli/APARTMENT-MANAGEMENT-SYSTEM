...
echo ' 
<p>Guest ID: <input type="text" name="guest_id" size="10" maxlength="50" value="'.$guest_id.'" class="textbox"/></p> 
...
if (isset($_POST['submitted'])) {
    ...
    $errors = array(); 
    checkIfEmpty($_POST['guest_id'],"Please enter guest ID.",$errors);
    ...
    if (empty($errors)) { 
        $query = "INSERT INTO guests(guest_id,guest_first_name,guest_last_name,guest_date_of_birth,guest_gender)
        VALUES ('$guest_id','$guest_first_name','$guest_last_name','$guest_date_of_birth 00:00:00','$guest_gender')";
        addTable($dbc,$query);
    }else {  
